        ...
        <Routes>
          ...
          <Route element={<Layout />}>
            <Route element={<ProtectedRoute allowedRoles={['ALUMNO']} />}>
              ...
              <Route path="/alumno/dashboard" element={<Navigate to="/alumno" replace />} />
              <Route path="/alumno/clases" element={<AlumnoClasesPage />} />
              <Route path="/alumno/clases/:claseId" element={<AlumnoClaseDetailPage />} />
              <Route path="/alumno/encuestas" element={<AlumnoEncuestasPage />} />
              <Route path="/alumno/encuestas/:encuestaId" element={<AlumnoEncuestaClasePage />} />
              <Route path="/alumno/encuesta/:campanaId/:asignaturaId" element={<EncuestaForm />} />
            </Route>

            <Route element={<ProtectedRoute allowedRoles={['PROFESOR']} />}>
              <Route path="/profesor" element={<Navigate to="/profesor/clases" replace />} />
              <Route path="/profesor/clases" element={<ProfesorClasesPage />} />
              <Route path="/profesor/clases/:claseId" element={<ProfesorClaseDetailPage />} />
              <Route path="/profesor/encuestas" element={<ProfesorEncuestasPage />} />
              <Route path="/profesor/encuestas/:encuestaId" element={<ProfesorEncuestaDetailPage />} />
...
const HomeRedirect = () => {
  ...
  if (role === 'PROFESOR') return <Navigate to="/profesor/clases" replace />;
